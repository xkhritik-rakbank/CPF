...
public class CPFCommunication {
	...
	public static void sendMail(String fromMailID, String toMailID,String mailCC, String cabinetName, String sessionId,String mailSubject,String MailStr,String ProcessDefID,String activityId,String stage,String WI_NAME,String wsName,String processName,String dataSource,String category )throws Exception
	{
		...
		if(mainCodeforAPInsert.equalsIgnoreCase("0"))//if(result>0)
		{
			...
			InsertRecordInCommHistory(WI_NAME,wsName,processName,sessionId,"Email","Done",fromMailID,toMailID,mailCC,category,mailSubject,MailStr);
		}
		else
		{
	...
	public static void sendSMS(String Mobile_No, String Alert_Text, String cabinetName, String sessionId,String ProcessDefID,String wsname,String stage,String WI_NAME,String processName,String dataSource ,String category)throws Exception
	{
		...
		if(mainCodeforAPInsert.equalsIgnoreCase("0"))//if(result>0)
		{
			...
			UpdateCommFlag(WI_NAME,stage,processName,sessionId,"'Done'");
			InsertRecordInCommHistory(WI_NAME,wsname,processName,sessionId,"SMS","Done","NA",Mobile_No,"NA",category,Alert_Subject,Alert_Text);
		}
		else
		{
	...
	public static void UpdateCommFlag(String WI_NAME,String stage,String processName, String sessionId,String value)
	{
		String exttableName="";
	...
	public static void InsertRecordInCommHistory(String WI_NAME,String wsname,String processName, String sessionId,String commType,String value,String fromMailID,String toMailID,String mailCC,String category,String sub,String content)
	{
		String historyTable="";
			...
			try
			{
				if(wiName!=null)
				{
					if("Email".equalsIgnoreCase(commType))
						mailSearchCriteria=CPFMain.sURN;
					
					String colName="WI_NAME,EMAIL_OR_SMS,SENT_DATE,RECIPIENT,COPIED_IDs,FROM_ID,DELIVERY_STATUS,CATEGORY,WSNAME,REMARKS,COMM_SUBJECT,COMM_CONTENT,mail_search_criteria";
					
	                String values="'"+wiName+"','"+commType+"',getDate(),'"+RECIPIENT+"','"+COPIED_IDs+"','"+FROM_ID+"','"+status+"','"+category+"','"+wsname+"','"+remarks+"','"+sub+"',N'"+content+"','"+mailSearchCriteria+"'";
